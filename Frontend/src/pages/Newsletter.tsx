...
const Newsletter = () => {
  ...
  return (
      ...
      <div className="max-w-7xl mx-auto text-white px-4 flex-1 flex flex-col justify-center min-h-0">
    ...
    >
      <div className="overflow-hidden">
        {article.image ? (
          ...
          <div className="w-full h-54 bg-gradient-to-br from-purple-700/50 to-pink-700/50 flex items-center justify-center">
