      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className="fixed bottom-[13rem] md:bottom-[9rem] right-4 z-40 w-[calc(100vw-2rem)] sm:w-96 flex flex-col rounded-2xl border border-white/10 bg-[#0a0a0a] shadow-2xl overflow-hidden"
