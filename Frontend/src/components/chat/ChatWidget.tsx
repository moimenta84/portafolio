  ...
  return (
    <>
      ...
      <AnimatePresence>
        {showLabel && !open && (
          <motion.div
            ...
            className="fixed bottom-[5.75rem] right-[4.5rem] z-40 flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-[#0a0a0a] border border-cyan-500/30 shadow-lg pointer-events-none"
          >
      ...
      <button
        ...
        className="fixed bottom-20 right-4 z-40 flex items-center justify-center w-12 h-12 rounded-full bg-cyan-500/20 border border-cyan-500/40 text-cyan-400 shadow-lg hover:bg-cyan-500/30 hover:scale-105 transition-all"
      >
